...
const lawnGreen = "#FFCB00";
const trackColor = "#343434";
const edgeColor = "#725F48";
const treeCrownColor = 0xFF9705;
...
const resultsfElement = document.getElementById("resultsf");
const resultspElement = document.getElementById("resultsp");
...
function reset() {
  ...
  resultsfElement.style.display = "none";
  resultspElement.style.display = "none";
...
function hitDetection() {
  ...
  if (hit && score != 16) {
    if (resultsfElement) resultsfElement.style.display = "flex";
    renderer.setAnimationLoop(null); // Stop animation loop
  }
  else if(hit && score == 16){
    if (resultspElement) resultspElement.style.display = "flex";
    renderer.setAnimationLoop(null); // Stop animation loop
  }
}
